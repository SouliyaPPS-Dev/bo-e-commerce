...
const customLaoMessages: TranslationMessages = {
  ...
  old_price: "ລາຄາເກົ່າ",
  sort_by: "ຈັດຮຽງຕາມ",
  sort_newest: "ໃໝ່ທີ່ສຸດ",
  sort_oldest: "ເກົ່າທີ່ສຸດ",
  sort_popular: "ນິຍົມ",
  colors: "ສີ",
  ...
  design_story: "ເລື່ອງລາຍການອອກແບບ",
  design_story_en: "ເລື່ອງລາຍການອອກແບບ (ອັງກິດ)",
  design_story_la: "ເລື່ອງລາຍການອອກແບບ (ລາວ)",
  exceptional_quality: "ຄຸນນະພາບພິເສດ",
  exceptional_quality_en: "ຄຸນນະພາບພິເສດ (ອັງກິດ)",
  exceptional_quality_la: "ຄຸນນະພາບພິເສດ (ລາວ)",
  ethical_craft: "ຫັດຖະກໍາທີ່ມີຈິດສຳນຶກ",
  ethical_craft_en: "ຫັດຖະກໍາທີ່ມີຈິດສຳນຶກ (ອັງກິດ)",
  ethical_craft_la: "ຫັດຖະກໍາທີ່ມີຈິດສຳນຶກ (ລາວ)",
  timestamps: "ເວລາ",
  ccy: "ລະຫັດສະກຸນເງິນ",
  type: "ປະເພດ",
  rate: "ອັດຕາແລກປ່ຽນ",
  ...
  resources: {
    product_variants: {
      ...
      filters: {
        search: "ຄົ້ນຫາສິນຄ້າຍ່ອຍ...",
      },
      notifications: {
        created: "ສ້າງສິນຄ້າຍ່ອຍສໍາເລັດ",
        updated: "ອັບເດດສິນຄ້າຍ່ອຍສໍາເລັດ",
        deleted: "ລຶບສິນຄ້າຍ່ອຍສໍາເລັດ",
      },
    },
    customers: {
      name: "ລູກຄ້າ |||| ລູກຄ້າ",
